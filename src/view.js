...
import {PATCH_LISTENER, DELETE_LISTENER} from "./main.js"
...
function getDateAndTimeFromApi(elem) {
    return [elem[0].split("-").reverse().join("."),  // Date
...
export {createTable, createModalNewClient, createContactEntry, setModalNameFields}